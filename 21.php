<input class="_21" type="button" value="<< todos los generos" onclick="javascript:ajaxGenre()"/>  
<br/>
<?php
    require_once "EscucharadioConnection.php";
    $connection = new EscuchaRadioConnection();
    $sql = "SELECT genre_name,station_id,station_name,station_url,station_language,station_active,station_type FROM stations LEFT JOIN genre ON (station_genre = genre_id) WHERE (station_active = 1) and (genre_id = ".$_POST['genreId'].") ORDER BY station_clicks desc";
